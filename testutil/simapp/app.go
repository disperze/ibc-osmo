...
func NewSimApp(
	...
	app.mm.SetOrderBeginBlockers(
		...
		authz.ModuleName, feegrant.ModuleName, paramstypes.ModuleName, vestingtypes.ModuleName,
		ibchost.ModuleName, ibctransfertypes.ModuleName, ibcmock.ModuleName, ibcgammtypes.ModuleName,
	)
	...
	app.mm.SetOrderInitGenesis(
		...
		paramstypes.ModuleName, upgradetypes.ModuleName, vestingtypes.ModuleName, ibcgammtypes.ModuleName,
	)
